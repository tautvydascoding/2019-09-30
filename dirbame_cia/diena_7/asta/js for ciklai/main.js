...
//NEVEIKIA TEISINGAI
for (var x = 0; x<10; x++){
document.querySelector('header').innerHTML += "<p>Aprasymas</p>" + x;
}
...
for (var x = 0; x < 6; x++){
document.querySelector('div').innerHTML += "<li> elementelis </li>" + x;
}
// 2.0 UZDUOTIS
...
//for (var x = 0; x < 100; x++){
  ...
  //console.log(printX('atspausdinta atspausdinta atspausdinta'));
//}
...
//Nepavyko...
//for (var x = 0; x < 12; x++){
  //printX(.nuotraukos.picture.jpg);
  //console.log(printX(.nuotraukos.picture.jpg))
//}
