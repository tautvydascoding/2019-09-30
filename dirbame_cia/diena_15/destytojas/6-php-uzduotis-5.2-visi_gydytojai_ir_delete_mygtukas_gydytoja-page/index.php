...
while ($gydytojas_Array) : ?>
    <h3>
        <a href="doctor.php?numeris=<?php   echo $gydytojas_Array['id'] ?>">
            <?php echo "{$gydytojas_Array['name']}  {$gydytojas_Array['lname']} " ?>
        </a>
        <a class="btn btn-outline-danger"href="trintiGydytoja.php?numeris=<?php   echo $gydytojas_Array['id'] ?>">    Trinti     </a>
    </h3>
