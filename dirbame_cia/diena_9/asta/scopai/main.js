...
//------
 ...
 function test2() {
    ...
    console.log("2 this.katinas - f-jos viduje: ",  this.katinas);    // this - pasiekia ~global kintamuosius (tavo tecio kintamuosius) pakyla vienu aukstu auksciau
 }
 test2();
...
//==========================
 ...
 function myName ( vardas ) { //  vardas - local kintamasis
     ...
     // window kreipiasi i globalu kintamaji, nebutinai vienu aukstu auciau, bet visiskai globalu
 }
 myName("PETRAS");
//======================TEKSTO ISVEDIMAS===============
//namie!
