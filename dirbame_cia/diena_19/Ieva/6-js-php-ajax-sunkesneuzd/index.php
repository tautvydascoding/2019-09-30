...
<html>
    ...
    <body>
        ...
        <h2 id='gautiGydytoja'> Gydytojas: </h2>

        <input type="text" name="gydytojoNR" id="gydytojoNR" placeholder="ivesk gydytojo NR">
        <button onclick="getDoctorwithAjax()">Gauti Gydytoja</button>
