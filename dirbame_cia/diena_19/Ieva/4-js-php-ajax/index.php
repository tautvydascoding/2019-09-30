...
<html>
    ...
    <body>
        ...
        <div id='results'> Atsakymukas: </div>
        <input type="text" name="vard" id="vardas" placeholder="ivesk varda">
        <button onclick="getNameLocationwithAjax()">Get atsakymukas</button>
