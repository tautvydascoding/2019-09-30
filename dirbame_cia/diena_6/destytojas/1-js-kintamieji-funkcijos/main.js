...
// =============================
let manoElemntas = " <h1 class='bg-info' title='tekstas'>Naujas tekstas</h1>";

let  z =  (((2 - 2 / 3)))  - Math.PI * Math.sin(46) + Math.floor;
...
pazymiuVidurkis1(10, 4, 4, 7, 10);
pazymiuVidurkis1(1, 4, 4, 7, 6);
pazymiuVidurkis1(7, 8, 8, 7, 10);
...
function getVardasPavarde() {
    ...
    let fullname = vardas + " " + pavarde;  // sudedame tekstus i viena sakini
    // let fullname = "Pradzia" + " " + "pabaiga";  // sudedame tekstus i viena sakini
    return fullname;
}
let duomenys = getVardasPavarde();
...
// C) patikrinti ar veikia f-ja
function getPelnas() {
    let pajamos = 12500;   // local
    let islaidos = 7500;  // local
    let pelnas =   pajamos - islaidos;      // local
    return pelnas;
}
...
function getPelnas2(pajamos, nuostoliai) {
    let pelnas =   pajamos - nuostoliai;      // local
    return pelnas;
}
let tikrasPelnas = getPelnas2();
console.log("tikrasPelnas:" + tikrasPelnas);
...
let y2 = pazymiuVidurkis3(10, 4, 4, 7, 10);
let y3 = pazymiuVidurkis3(1, 4, 4, 7, 6);
let y4 = pazymiuVidurkis3(7, 8, 8, 7, 10);
